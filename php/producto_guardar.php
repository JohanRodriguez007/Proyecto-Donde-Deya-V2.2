<?php
require_once "../controlador/SessionController.php"; // Incluir el archivo SessionController
...
if (!isset($_SESSION['id'])) {
    echo '
        <div class="notification is-danger is-light">
            ...
            Debes iniciar sesión para poder guardar productos.
        </div>
    ';
    exit();
}
...
/*== Almacenando datos ==*/
$codigo = Utils::limpiar_cadena($_POST['producto_codigo']);
$nombre = Utils::limpiar_cadena($_POST['producto_nombre']);
$precio = Utils::limpiar_cadena($_POST['producto_precio']);
$stock = Utils::limpiar_cadena($_POST['producto_stock']);
$categoria = Utils::limpiar_cadena($_POST['producto_categoria']);
...
if (Utils::verificar_datos("[a-zA-Z0-9- ]{1,70}", $codigo)) {
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
...
if (Utils::verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}", $nombre)) {
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
...
if (Utils::verificar_datos("[0-9.]{1,25}", $precio)) {
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
...
if (Utils::verificar_datos("[0-9]{1,25}", $stock)) {
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
...
if ($_FILES['producto_foto']['name'] != "" && $_FILES['producto_foto']['size'] > 0) {
    ...
    /* Nombre de la imagen */
    $img_nombre = Utils::renombrar_fotos($nombre); // Asumiendo que esta función también está en Utils.php
...
/*== Guardando datos ==*/
$guardar_producto = Utils::conexion();
