...
/*== Almacenando id ==*/
$id = Utils::limpiar_cadena($_POST['categoria_id']);
...
/*== Almacenando datos ==*/
$nombre = Utils::limpiar_cadena($_POST['categoria_nombre']);
...
if (Utils::verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}", $nombre)) {
    echo '
        <div class="notification is-danger is-light">
            <strong>¡Ocurrio un error inesperado!</strong><br>
...
/*== Actualizar datos ==*/
$actualizar_categoria = Utils::conexion();
