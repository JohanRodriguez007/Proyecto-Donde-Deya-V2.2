<?php
require_once './modelo/Utils.php';  // Incluir archivo Utils.php para conexion() y paginador_tablas()
...
$conexion = Utils::conexion();  // Usando la función conexion() de Utils.php
...
if ($total >= 1 && $pagina <= $Npaginas) {
    echo Utils::paginador_tablas($pagina, $Npaginas, $url, 7);  // Usando paginador_tablas() de Utils.php
}
?>
