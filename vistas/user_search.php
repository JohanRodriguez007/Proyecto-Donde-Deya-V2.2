<?php
// Inicia el almacenamiento en búfer de salida para evitar problemas con los encabezados
ob_start();
...
// Termina el almacenamiento en búfer de salida y envía el contenido al navegador
ob_end_flush();
?>
